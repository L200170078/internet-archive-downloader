              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <?php if (isset($_GET['error'])) { ?>
                  	<?php if($_GET['error']==1) { $text = 'username not found. '; } ?>
                  	<?php if($_GET['error']==2) { $text = 'password does not match.'; } ?>
                  	<?php if($_GET['error']==3) { $text = 'silahkan ulangi kembali.'; } ?>
	                <div class="alert alert-danger alert-dismissible fade show" role="alert">
						<strong>Login failed!</strong> <?php echo $text; ?>
